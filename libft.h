...
/*   Updated: 2024/02/21 16:30:10 by florian          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * ’del’ given as a parameter and free the node. 
 ...
 * returns a pointer to it. Sets allocated Memory to zero.
...
/**
 * @brief Copies the character c to the first n 
 ...
 * @param s This is the pointer to the block of 
 * memory where the search is performed.
 * @param c This is the value to be passed as an int, 
 * but the function performs a byte per byte search using 
...
/**
 * @brief Copies n characters from s2 to s1, but for 
 * overlapping memory blocks. Safer than memcpy.
 * @param s1 This is pointer to the destination array
 *  where the content is to be copied, type-casted to a pointer of type void*.
 * @param s2 This is pointer to the source of data to be copied,
 ...
 * @param s This is the C string to be scanned.
 * @param c This is the character to be searched in str.
 * @return This returns a pointer to the last occurrence of the 
